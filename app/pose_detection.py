...
def run_pose_detection(base64_string):
    try:
        # Save the decoded image to a temp file
        image_path = "temp_input.jpg"
        with open(image_path, "wb") as f:
            f.write(base64.b64decode(base64_string))

        model_path = "./movenet_full_256.tflite"
        result = predict(model_path, image_path, "annotated_output.jpg")
        return result
